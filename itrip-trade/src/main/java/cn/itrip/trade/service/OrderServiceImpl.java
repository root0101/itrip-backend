...
public class OrderServiceImpl implements OrderService {
	...
	public void paySuccess(String orderNo, int payType,String tradeNo) throws Exception {
		...
		itripHotelOrder.setOrderStatus(2);	// 已支付
	...
	public boolean processed(String orderNo) throws Exception {
		...
		boolean isPaySuccessed = itripHotelOrder.getOrderStatus().equals(2) && EmptyUtils.isNotEmpty(itripHotelOrder.getTradeNo());

		// 返回
		return isPaySuccessed;
	}
